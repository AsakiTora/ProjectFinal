package com.app.projectfinal.Anim;
...
public class AnimationUtil {
    ...
    public static void translateAnimation(final ImageView viewAnim, final View startView, View endView,
        ...
        viewAnim.setImageBitmap(bitmap);
        ...
        ScaleAnimation translateScaleAnimation = new ScaleAnimation(1.0f, 1.5f, 1.0f, 1.5f, toX, toY);
        ...
        viewAnim.startAnimation(animationSet);
